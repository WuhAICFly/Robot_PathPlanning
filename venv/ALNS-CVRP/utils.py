...
def get_config(args=None):
    ...
    #help：对参数的简单，描述
    parser.add_argument('--customers_num', type=int, default=22, help="客户最大数量")
    parser.add_argument('--capacity', type=float, default=3000, help="车辆最大容量")
...
def draw(solutionbest,locations,figname):
    #路线图绘制
    fig=plt.figure(1)
