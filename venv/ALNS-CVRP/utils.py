...
def get_config(args=None):
    ...
    #help：对参数的简单，描述
    ##改3
    parser.add_argument('--customers_num', type=int, default=33, help="客户最大数量")
    parser.add_argument('--capacity', type=float, default=120, help="车辆最大容量")
...
def mkfile():
    # 获取要创建的文件夹路径
    folder_path = "C:/Users/wuhon/Desktop/AA/B"
